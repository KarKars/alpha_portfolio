            ...
            <div className="row text-center mt-2 justify-content-center">
              ...
              <div className="row justify-content-evenly align-items-center">
                ...
                <div className="col">
                  <h2>
                    <a
                      href="https://drive.google.com/file/d/1WEoQ2j7fmCVXBs532UXDtimxYC6PQw-F/view?usp=sharing"
                      target="_blank"
                    >
                      <ImProfile />
                    </a>
          ...
          <div className="col-md text-center text-md-start mt-5 mt-md-0 ">
            ...
            <div className="row mt-5">
              <h4>
                ...
                4 years of experience. I have extensive knowledge of both frontend and backend
